	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			<div class="container team-container">
				<h1 id="meet">Meet '<span class="initials">k</span>' and '<span class="initials">n</span>'</h1>

				<div class="row kyle-row">
					<div class="background-shape triangle">
					</div>
					...
					<div class="col-sm-offset-1 col col-sm-6">
						<div class="biography">
							...
							<p>
							*That means climb for any of you non-climbing folks
							</p>
						</div>
					</div>
				</div><!-- row -->

				<div class="row second-team-row">
					<div class="background-shape rectangle">
					</div>
